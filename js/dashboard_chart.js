...
const defaultPrices = JSON.parse(localStorage.getItem('defaultPrices'));
const curves_to_display = Object.keys(defaultPrices).length + 1;
...
function display_new_curve() {
    ...
    let full_name = defaultPrices[trigram]["full_name"];
    let color = defaultPrices[trigram]["colour"];
